...
<body>
	...
	<%
			...
			String str = "SELECT * FROM admin where id = " + id;
			
    
    ResultSet result = stmt.executeQuery(str);
    if (result.next()){
    	 ResultSet result2;
    	    result2 = stmt.executeQuery("select * from admin where id='" + id + "' and password='" + pw + "'");
    	    if (result2.next()) {
		...
		<br>
		<form method = "get" action = "CreateAAccount.jsp">
				<input type="submit" value = "Create New Admin Account">
				</form>
</body>
</html>